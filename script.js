...
function update() {
  ...
  document.getElementById('textBio').innerHTML = `Ребят, я fdacky.<br><br>Наверное мне уже ${date.getFullYear() - 2007} лет, по этому хочу сказать что я вахуе, старый пиздец`
